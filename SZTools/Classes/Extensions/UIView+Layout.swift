...
public extension UIView {
    ...
    /// 添加一个宽度约束
    @discardableResult
    public func zs_addWidthConstraint(_ width: CGFloat) -> NSLayoutConstraint {
    ...
    /// 添加一个高度约束
    @discardableResult
    public func zs_addHeightConstraint(_ height: CGFloat) -> NSLayoutConstraint {
    ...
    /// 等宽约束
    @discardableResult
    public func zs_equalWidth(view: Any, multiplier: CGFloat = 1.0, constant: CGFloat = 0.0) -> NSLayoutConstraint {
    ...
    /// 等高约束
    @discardableResult
    public func zs_equalHeight(view: Any, multiplier: CGFloat = 1.0, constant: CGFloat = 0.0) -> NSLayoutConstraint {
    ...
    /// 添加一个高度约束
    @discardableResult
    public func zs_addHeightConstraint2(_ height: CGFloat) -> NSLayoutConstraint {
        let lc = NSLayoutConstraint(item: self, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: height)
        self.addConstraint(lc)
        return lc
    }
    ...
    @discardableResult
    public func zs_leadingTo(view: Any, constant: CGFloat) -> NSLayoutConstraint {
    ...
    /// 与 view leading 对齐的约束
    @discardableResult
    public func zs_leadingAlign(view: Any, constant: CGFloat = 0.0) -> NSLayoutConstraint {
        let lc = NSLayoutConstraint(item: self, attribute: .leading, relatedBy: .equal, toItem: view, attribute: .leading, multiplier: 1.0, constant: constant)
        self.addConstraint(lc)
        return lc
    }
    ...
    @discardableResult
    public func zs_trailingAlign(view: Any, constant: CGFloat = 0.0) -> NSLayoutConstraint {
    ...
    @discardableResult
    public func zs_followTo(view: Any, constant: CGFloat = 0.0) -> NSLayoutConstraint {
    ...
    @discardableResult
    public func zs_under(view: Any, constant: CGFloat = 0.0) -> NSLayoutConstraint {
